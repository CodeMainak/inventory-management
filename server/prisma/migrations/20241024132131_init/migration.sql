...
-- AddForeignKey
ALTER TABLE "Sales" ADD CONSTRAINT "Sales_productsProductId_fkey" FOREIGN KEY ("productsProductId") REFERENCES "Products"("productId") ON DELETE SET NULL ON UPDATE CASCADE;
